...
void comunicator::setCommandMap(CommandEntry *_commandMap,
                                int8_t _commandMapSize) {
  commandMap = _commandMap;
  commandMapSize = _commandMapSize;
...
Command comunicator::readCommand() {
...
void comunicator::runCommand(Command _recivedCommand) {
...
int8_t comunicator::isCommandRegistered(Command _recivedCommand) {
