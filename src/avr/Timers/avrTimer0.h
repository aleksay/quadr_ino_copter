...
// #define SET_TIMER0_MODE_NORMAL                  TCCR0B |= (0 <<
// WGM02);TCCR0A
// |= (0 << WGM01) | (0 << WGM00)
#define SET_TIMER0_MODE_NORMAL                                                \
  TCCR0B &= ~(1 << WGM02);                                                    \
  TCCR0A &= ~((1 << WGM01) | (1 << WGM00))
// #define SET_TIMER0_MODE_PHASE_CORRECT_TOP       TCCR0B |= (0 <<
// WGM02);TCCR0A
// |= (0 << WGM01) | (1 << WGM00)
#define SET_TIMER0_MODE_PHASE_CORRECT_TOP                                     \
  ...
  TCCR0A &= ~(1 << WGM01);                                                    \
  TCCR0A |= (1 << WGM00)
// #define SET_TIMER0_MODE_CTC_OCRA                TCCR0B |= (0 <<
// WGM02);TCCR0A
// |= (1 << WGM01) | (0 << WGM00)
#define SET_TIMER0_MODE_CTC_OCRA                                              \
  ...
  TCCR0A |= (1 << WGM01);                                                     \
  TCCR0A &= ~(1 << WGM00)
// #define SET_TIMER0_MODE_FASTPWM_TOP             TCCR0B |= (0 <<
// WGM02);TCCR0A
// |= (1 << WGM01) | (1 << WGM00)
#define SET_TIMER0_MODE_FASTPWM_TOP                                           \
  TCCR0B &= ~(1 << WGM02);                                                    \
  TCCR0A |= (1 << WGM01) | (1 << WGM00)
// #define SET_TIMER0_MODE_PHASE_CORRECT_OCRA      TCCR0B |= (1 <<
// WGM02);TCCR0A
// |= (0 << WGM01) | (1 << WGM00)
